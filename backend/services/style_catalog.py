...
DEFAULT_STYLE_CATALOG: List[Dict[str, Any]] = [
    ...
    {"style_key": "accessory", "label": "Accessory", "dimension": "garment_type", "description": "Bag, jewelry, scarf, belt, or other accessory.", "aliases": ["accessories"], "sort_order": 116},
    {"style_key": "set", "label": "Set", "dimension": "garment_type", "description": "Matching two-piece outfit.", "aliases": ["coord", "co-ord"], "sort_order": 117},
    {"style_key": "swimwear", "label": "Swimwear", "dimension": "garment_type", "description": "Swim and resort garments.", "aliases": ["swim"], "sort_order": 118},
    {"style_key": "loungewear", "label": "Loungewear", "dimension": "garment_type", "description": "Comfort-focused indoor or at-home wear.", "aliases": ["lounge"], "sort_order": 119},
