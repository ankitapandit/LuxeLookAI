...
DEFAULT_STYLE_CATALOG: List[Dict[str, Any]] = [
    ...
    {"style_key": "accessory", "label": "Accessory", "dimension": "garment_type", "description": "Bags, belts, scarves, hats, and other non-jewelry finishing pieces.", "aliases": ["accessories"], "sort_order": 116},
